...
const TRACKED_CODES = new Set(['FOUNDERMYGRIND', 'FOREVERYOUNG2026', 'D1GRIND', 'ALLSTARMYGRIND', 'CALIFORNIAMYGRIND']);
...
const CAPS = {
  ...
  CALIFORNIAMYGRIND: 250,  // California coaches letter campaign (2026-08) — own cap
};
